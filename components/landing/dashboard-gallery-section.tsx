        ...
        <div className="mt-6 rounded-3xl border border-border bg-card shadow-xl p-3">
          <div className="relative w-full overflow-hidden rounded-3xl" style={{ aspectRatio: "16/9" }}>
            <Image
              ...
              alt={`Dashboard de ${current.label.toLowerCase()} en Viasentra, vista ${activeIndex + 1}`}
              fill
        ...
        <div className="mt-4 flex justify-center gap-3 overflow-x-auto pb-2">
          {current.images.map((img, i) => (
            <button
              ...
              aria-label={`Ver dashboard de ${current.label.toLowerCase()} ${i + 1}`}
            ...
            >
              <Image
                src={img}
                alt={`Vista miniatura ${i + 1} del dashboard de ${current.label.toLowerCase()}`}
                fill
