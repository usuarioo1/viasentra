...
const notificationScenarios = [
  {
    ...
    description: "Cada vez que se registra y asigna un servicio, el sistema dispara una notificación por correo.",
    trigger: "Se crea el servicio SV-1042",
    email: "operador.asignado@empresa.cl",
    details: ["Asignación del servicio", "Datos principales", "Acción requerida"],
  },
  {
    icon: ClipboardCheck,
    badge: "Actividad",
    ...
    details: ["Responsable definido", "Plazo visible", "Trazabilidad del envío"],
  },
]
...
const emailHighlights = [
  ...
  "Trazabilidad de envío para auditoría y cumplimiento.",
]
      ...
      <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl text-center">
          <div className="inline-flex items-center gap-2 rounded-full border border-primary/30 bg-primary/10 px-3 py-1">
            ...
            <span className="text-sm font-medium text-primary">Notificaciones automáticas</span>
          </div>
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-[1.2fr_0.8fr]">
          ...
          <aside className="rounded-2xl border border-border bg-card p-6 shadow-sm">
            ...
            <h3 className="mt-3 text-xl font-semibold text-foreground">Información accionable desde el primer minuto</h3>
            ...
            <div className="mt-6 rounded-xl border border-border bg-background p-4">
              ...
              <div className="mt-4 rounded-lg border border-border bg-card p-4">
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Se te asignó una nueva actividad con vencimiento para hoy a las 18:00. Revisa el detalle y confirma
                  recepción en la plataforma.
                </p>
              </div>
            </div>
          </aside>
